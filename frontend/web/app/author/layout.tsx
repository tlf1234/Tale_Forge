...
import { FaChevronRight, FaChevronLeft, FaHome, FaPen, FaBook, FaChartBar, FaWallet, FaCoins } from 'react-icons/fa'
    ...
    <div className={styles.layout}>
      ...
      <aside className={`${styles.sidebar} ${collapsed ? styles.collapsed : ''}`}>
        <nav className={styles.nav}>
          ...
          <Link 
            href="/author/token"
            className={`${styles.navLink} ${pathname === '/author/token' ? styles.active : ''}`}
          >
            <span className={styles.navIcon}><FaCoins /></span>
            <span>作者代币</span>
          </Link>
