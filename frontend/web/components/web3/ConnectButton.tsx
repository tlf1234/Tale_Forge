...
export default function ConnectButton({ className = '' }: { className?: string }) {
  ...
  const { isAuthor, isLoading: authorLoading } = useAuthorStatus()
        ...
        {isWalletModalOpen && mounted && createPortal(
          <div className={styles.modalOverlay} onClick={handleCloseModal}>
            <div className={styles.modalContent} onClick={e => e.stopPropagation()}>
                ...
                {isMobile ? (
                  ...
                  connectors
                    ...
                    .map((connector) => {
                      ...
                      const isInstalled = connector.ready || connector.id === 'walletConnect'
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={styles.walletInfo}>
                            ...
                            {!isInstalled && connector.id !== 'walletConnect' && config && (
              ...
              {/* 添加邮箱登录入口 */}
              <div className={styles.emailLoginOption}>
