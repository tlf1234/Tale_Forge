...
export function Header() {
  ...
  return (
    <header className={`${styles.header} ${isReadingPage ? styles.headerReading : ''}`}>
        ...
        <>
              ...
              <div className={styles.flexBetween}>
                ...
                <div className={styles.leftSection}>
                  ...
                  <nav className={styles.desktopMenu}>
                    ...
                    <Link 
                      href="/market/tokens" 
                      className={`${styles.navLink} ${pathname === '/market/tokens' ? styles.active : ''}`}
                    >
                      代币市场
                    </Link>
                    <Link 
          ...
          {isMobileMenuOpen && (
            <div className={styles.mobileMenu}>
              ...
              <Link 
                href="/market/tokens" 
                className={`${styles.mobileNavLink} ${pathname === '/market/tokens' ? styles.active : ''}`}
              >
                代币市场
              </Link>
              <Link 
      ...
      {/* 子导航栏 - 只在首页和作品页面显示 */}
      {!isReadingPage && (pathname === '/' || pathname === '/stories') && (
